...
const addTokenToWallet = (tokenSymbol, tokenAddress) => async () => {
  if (window.ethereum) {
    ...
    const tokenPath = tokenSymbol === "LOCKER" ? OhmImg : SOhmImg;
            ...
            <Fade {...TransitionProps} timeout={100}>
              <Paper className="ohm-menu" elevation={1}>
                <Box component="div" className="buy-tokens">
                  ...
                  <Link
                    href={`https://www.dextools.io/app/ether/pair-explorer/0xaca7b3f9212ccd5027af212a7c6e7c1bde3fafb0`}
                    target="_blank"
                    rel="noreferrer"
                  >
                    <Button size="large" variant="contained" color="secondary" fullWidth>
                      <Typography align="left">
                      Get LOCKER-ETH LP <SvgIcon component={ArrowUpIcon} htmlColor="#A3A3A3" />
                      </Typography>
                    </Button>
                  </Link>
                ...
                {(
                  <Box className="add-tokens">
                    ...
                    <Box display="flex" flexDirection="row" justifyContent="space-between">
                      <Button variant="contained" color="secondary" onClick={addTokenToWallet("LOCKER", '0x1cc29ee9dd8d9ed4148f6600ba5ec84d7ee85d12')}>
                        <TokenIcon size={32} symbol="PID"/>
                        <Typography variant="body1">LOCKER</Typography>
                      </Button>
