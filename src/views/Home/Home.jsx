...
function Home() {
  ...
  return <div className="home_gd">
    ...
    <div className="headBox">
      ...
      <ul className="uls">
        <li className="lis"><a className="a" href="https://memekong.io/">Home</a></li>
    ...
    <div className="boodyBox fxColumn">
      ...
      <div className="contentStyle">
        MemeKong Staking is a decentralized reserve currency protocol based on the Meme Kong token and aims at building a community-owned decentralized financial infrastructure for the crypto world.
      </div>
      <div className="fxBetween">
        <a href="/stake" className="btnBox_1">Enter App</a>
        <a href="https://memekong.io/" className="btnBox_2 a" target="_blank">Documentation</a>
      </div>
...
function Inp_Box({idoBalance,busdAmount}) {
  ...
  return <MinInp_Box>
    ...
    PIDAO project will launch on 12:00 8th Nov. 2021, you will be able to claim your LOCKER token manually on the website. 
    </div>
