...
import GovernanceList from "./views/Governance/GovernanceList";
    ...
    <Router>
      <ThemeProvider theme={darkTheme}>
        ...
        <div className={`app ${isSmallerScreen && "tablet"} ${isSmallScreen && "mobile"} light`}>
          ...
          <div className={`${path === "/" ? null : classes.content} ${isSmallerScreen && classes.contentShift}`} style={{ position: 'relative' }}>
            <Switch>
